...
public class Chassis {
    ...
    public void driveDirection(double x, double y, double speed, double rotationVal) {
        this.opmode.telemetry.addData("rotVal", Double.valueOf(rotationVal));
        this.opmode.telemetry.addData("XStick", Double.valueOf(y));
        this.opmode.telemetry.addData("YStick", Double.valueOf(x));
        ...
        this.opmode.telemetry.addData("FL Pow", Double.valueOf(frontLeftPower));
